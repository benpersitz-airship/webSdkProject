...
//   const tagArray = tagString.split('x')
// 	if (tagNU.checked) {
//     const SDK = await UA
//     const channel = await SDK.getChannel()
//     channel.namedUser.tags.add(tagArray,tagGroup)
// 	} else {
//     channel.tags.add(tagArray,tagGroup)
// 	}
// }
...
async function setAttrs() {
	...
	const valueList = {"first_name": fnValue, "last_name": lnValue,"loyalty_tier": tierValue}
	...
	if (attrNU.checked) {
		...
		results == true ? console.log("Attributes set") : console.log("An error occurred")
	} else {
